            ...
            <div id="aboutme" className="sm:flex flex-initial block outline outline-1">
                <div className="flex flex-col">
                    ...
                    <div className="flex-grow flex p-4 bg-blue-200 text-3xl font-serif text-left">
                        Hello! <br></br><br></br> Welcome to my portfolio. My name is Jason Gabianelli. I am a recent UC Berkeley FullStack Web Development bootcamp graduate born and raised in the San Francisco Bay Area. This page displays and showcases the work and projects I've done as well as projects I've contributed to. Feel free to see some of my work so far. I have a passion for coding and I am meticulous, hard-working, outgoing, friendly, and I am ready to take on any challenge.
                ...
                <img className="flex-grow md:max-w-[30%] outline outline-1" src={personalPhoto} alt="" />
            </div>
        </>
    )
}
