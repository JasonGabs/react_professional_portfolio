...
const Contact = () => {
    return (
        <div className="outline outline-1">
            ...
            <a href="https://www.linkedin.com/in/jason-gabianelli-640b20212/" target="_blank" rel="noreferrer" className="flex truncate font-serif bg-blue-300 text-3xl p-4 min-w-full">
